...
/* .site-header {
  @apply sticky top-0 z-50 border-b border-white/10 bg-black/95 backdrop-blur-md;
}
...
.logo-section {
  @apply flex justify-center border-b border-white/5 py-6;
}
...
.nav-link {
  @apply text-sm font-medium uppercase tracking-wider text-white/80 transition hover:text-accent;
  letter-spacing: 0.1em;
}


.mobile-header {
  @apply flex items-center justify-between py-4 md:hidden;
}
...
.hamburger-button {
  @apply rounded-md p-2 text-white transition hover:bg-white/10 hover:text-accent focus:outline-none focus:ring-2 focus:ring-accent;
}
...
.mobile-menu-panel {
  @apply fixed left-0 right-0 bottom-0 z-40 flex flex-col bg-black md:hidden h-[100vh];
  top: 64px;
}

.mobile-menu-header {
  @apply flex flex-shrink-0 justify-end border-b border-white/5 px-6 py-4;
}

.mobile-close-button {
  @apply flex items-center gap-2 rounded-md px-3 py-2 text-sm font-medium uppercase tracking-wider text-white transition hover:bg-white/10 hover:text-accent;
  letter-spacing: 0.1em;
}
...
.mobile-nav {
  @apply flex flex-1 flex-col gap-2 overflow-y-auto px-6 py-8 ;
}

.mobile-nav-link {
  @apply rounded-lg px-4 py-4 text-lg font-medium uppercase tracking-wider text-white transition hover:bg-white/5 hover:text-accent;
  letter-spacing: 0.1em;
}
